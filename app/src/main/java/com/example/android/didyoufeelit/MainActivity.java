...
public class MainActivity extends AppCompatActivity {
    ...
    private class EarthquakeAsyncTask extends AsyncTask<String, Void, Event>{
         ...
         *
         * it is NOT okay to update the UI from a background thread, wo we just return an
         * {@link Event} object as the result.
         * @param urls takes urls at the array index 0
         * @return the results
         */
        @Override
        protected Event doInBackground(String... urls) {
            ...
            // Perform the HTTP request for earthquake data  in the background
         ...
         *
         * It is OK to modify the UI within this method. We take the {@link Event} object (which
         * was returned from the doInBackground() method) and update the views on the screen.
         * @param result
         */
        @Override
